...
class Warehouse(models.Model):
    ...
    capacity = models.CharField("Capacidad", max_length=100, blank=True, null=True, help_text="Ej: 200 m³, 50 toneladas")
    description = models.TextField("Descripción", blank=True, null=True)
    is_active = models.BooleanField("Activo", default=True)
    created = models.DateTimeField("Fecha de creación", auto_now_add=True)
    updated = models.DateTimeField("Fecha de actualización", auto_now=True)
...
class InventoryMovement(models.Model):
    ...
    crop = models.ForeignKey('crop.Crop', on_delete=models.SET_NULL, null=True, blank=True, related_name='inventory_movements', verbose_name='Cultivo destino')
    labor = models.ForeignKey('labores.Labor', on_delete=models.SET_NULL, null=True, blank=True, related_name='inventory_movements', verbose_name='Labor destino')
